# Merge startup program - Sourcey entity record

- **Pull request**: https://github.com/sourcey/startup-credits/pull/1278 adds one file, `entities/me/merge.yaml`, with one new entity and exactly one offer. No code, no schema, no generated output, no unrelated files.
...
- **Source**: https://www.merge.dev/offers/startup-program is the only cited source and is a page on the vendor's own domain. It was fetched and returned HTTP 200 on 2026-09-04. No directory or aggregator listing is cited.
- **Identity path**: the slug is `merge`, so the record sits at `entities/me/merge.yaml`, shard and file name both derived from the slug. Fresh `ent_` and `off_` ULIDs, one file-local `source_id`.
...
- **sha256 of the entity file**: `c711ad33d54179f66de40008b71d3668e152e9b92136c6c31237643bbe9ef945`
